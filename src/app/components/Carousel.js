...
function Carousel() {
  return (
    <div className="bg-[#1D2330] overflow-hidden fixed h-16 box-border pb-10 bottom-0 border border-[#282E3B] text-right leading-3 text-xs shadow-inner w-10/12 m-0">
